"""案例 19i：重点关注个股回测对比（隆基绿能 vs 澜起科技）

与 19h 同样的三买策略框架，应用到两只个股：
- 601012.SH  隆基绿能
- 688008.SH  澜起科技
...
产物：
    docs/examples/_output/19i_focus_stocks_comparison/*.html
"""
...
OUTPUT_DIR = Path(__file__).resolve().parent / "_output" / "19i_focus_stocks_comparison"
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

FEE_RATE = 0.0002
YEARLY_DAYS = 252
SYMBOLS = ["601012.SH", "688008.SH"]
